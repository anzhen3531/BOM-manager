...
public class PromotionObjectsWizardTableView extends PromotionObjectsTableView {
    ...
    private static final String[] COLUMN_IDS = new String[]{"promotionStatus", "promotionInitialSelectionStatus", "statusFamily_General", "statusFamily_Share", "latestStatus", "promotionMessageStatus", "type_icon", "number", "orgid", "version", "name", "state", "promotableStates", "selectedForPromoteStatus", "promotionTargetComments", "validateStatus"};
    ...
    public List<?> getSpecialTableColumnsAttrDefinition(Locale var1) {
        ...
        var2.add(new Attribute.TextAttribute("validateStatus", "validateStatus", var1));
        return var2;
    }
