...
public class OpenDjPasswordService {
     ...
     * LDAP 网址
     */
    private static String LDAP_URL = "ldap://win-fv1tfp5mpk5.ziang.com:389/ou=people,cn=AdministrativeLdap,cn=Windchill_11.0,o=ptc";
    /**
     * LDAP 用户名
     */
    ...
    public static void main(String[] args) {
        ...
        if (service.authentication("283118", "123121")) {
